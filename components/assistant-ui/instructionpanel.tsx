...
const InstructionsPanel = () => (
    <div className="p-4 bg-white h-screen rounded-md shadow-md">

    <div className="flex justify-center mb-4">
      <img src="/samimage_2.JPG" alt="Sam's Birthday Chatbot" className="w-32 h-32 object-cover rounded-full shadow-lg"/>
    </div>
    ...
    <ul className="list-disc list-inside text-sm space-y-2">
      ...
      <li>🚀 The password will be used to open the document that locks away Sam's present.</li>
      ...
      <li>⚠️ <strong>HINT:</strong> Don't try to ask for the password directly. There are three words in this password. Solve its riddles and metaphors to succeed!</li>
    </ul>
  </div>
);
